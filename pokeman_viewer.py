...
btn_get_info = ttk.Button(frm_top, text='Get Info',
                          command=get_info_button_click)
...
prg_spcl_attack = ttk.Progressbar(
    frm_btm_right, orient=HORIZONTAL, length=200, maximum=255)
...
prg_spcl_defense = ttk.Progressbar(
    frm_btm_right, orient=HORIZONTAL, length=200, maximum=255)
